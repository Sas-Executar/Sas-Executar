...
Depois, inicie a **ONDA 1 · FUNDAÇÃO SAAS + PRESERVAÇÃO DO PRODUTO** e execute-a de ponta a ponta seguindo o runner.
...
- não introduza microserviços, CRM, ERP, marketplace, mobile ou Copiloto nesta primeira onda;
...
Ao terminar a Onda 1, não comece silenciosamente a Onda 2. Entregue primeiro o relatório canônico do runner com:
