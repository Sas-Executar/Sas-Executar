...
const CSP_DIRECTIVES = [
  ...
  "script-src 'self' 'unsafe-inline' https://*.clerk.accounts.dev https://*.clerk.com https://va.vercel-scripts.com https://cdn.jsdelivr.net",
  "style-src 'self' 'unsafe-inline'",
  "font-src 'self' data:",
  "img-src 'self' data: blob: https://img.clerk.com https://*.clerk.com",
  "connect-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://*.liveblocks.io wss://*.liveblocks.io https://*.knock.app wss://*.knock.app https://*.posthog.com https://*.sentry.io https://*.ingest.sentry.io https://*.vercel-insights.com https://cdn.jsdelivr.net https://tessdata.projectnaptha.com",
