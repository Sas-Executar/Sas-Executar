...
export const entregaMobileSchema = z
  .object({
...
export const diaOperacionalMobileSchema = z
  .object({
...
export const evidenciaMobileSchema = z
  .object({
...
export const projecaoEstadoMobileSchema = z
  .object({
...
export const respostaEstadoMobileSchema = z
  .object({
...
export type DiaOperacionalMobile = z.infer<typeof diaOperacionalMobileSchema>;
export type EvidenciaMobile = z.infer<typeof evidenciaMobileSchema>;
export type ProjecaoEstadoMobile = z.infer<typeof projecaoEstadoMobileSchema>;
export type RespostaEstadoMobile = z.infer<typeof respostaEstadoMobileSchema>;
